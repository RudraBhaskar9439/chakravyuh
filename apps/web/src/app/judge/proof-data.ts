...
export const funnel = [
  ...
  { label: "Webhook-confirmed recoveries", value: 402, note: "No request-only recovery credit" },
] as const;
...
export const meshNodes = [
  ...
  { id: "confirmed", label: "Webhook confirmation", detail: "Only recovery credit", lane: 10 },
] as const;

export const chaosChecks = [
