...
Every phase must leave the repository deployable, produce executable evidence, and stop for owner
review. Later phases may extend an earlier schema only through a migration.
